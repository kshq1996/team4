			...
			<ul class="message-r">
				...
				<div class="topMessage my-shangcheng">
					<div class="menu-hd MyShangcheng">
						<a href="person/index.jsp" target="_top"> <i class="am-icon-user am-icon-fw"></i> 个人中心
						</a>
					</div>
				</div>
				<div class="topMessage mini-cart">
					<div class="menu-hd">
						<a id="mc-menu-hd" href="home/shopcart.jsp" target="_top"> <i class="am-icon-shopping-cart  am-icon-fw"></i> <span>购物车</span> <strong id="J_MiniCartNum" class="h">0</strong>
						</a>
					</div>
				</div>
													...
													<c:forEach var="hashmap" items="${requestScope.hashmapproducts}">
														<div class="order-content">
															<div class="order-left">
																<c:if test="${orders.order_id==hashmap.key}">
																	<c:forEach var="list" items="${hashmap.value}">
																		<ul class="item-list">
																			...
																			<li class="td td-price">
																				<div class="item-price">
																					<fmt:formatNumber value="${list.productCost}" pattern="0.00"></fmt:formatNumber>
																				</div>
																			</li>
																		...
																		<c:set var="count" value="${count+list.productCost*list.num}"></c:set>
																	</c:forEach>
																</c:if>
													</c:forEach>
										</div>
