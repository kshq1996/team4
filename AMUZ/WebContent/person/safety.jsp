...
<body>
	...
	<div class="center">
				...
				<div class="user-safety">
					...
					<div class="user-infoPic">
						...
						<div class="info-m">
							...
							<div class="u-safety">
								<a href="safety.html"> 账户安全 <span class="u-profile"><i class="bc_ee0000" style="width: 60px;" width="0">60分</i></span>
								</a>
							</div>
						</div>
					</div>
		...
		<aside class="menu">
			<ul>
				<li class="person"><a href="person/index.jsp">个人中心</a></li>
				<li class="person"><a href="#">个人资料</a>
					<ul>
						s
						<li><a href="person/information.jsp">个人信息</a></li>
						<li class="active"><a href="person/safety.jsp">安全设置</a></li>
