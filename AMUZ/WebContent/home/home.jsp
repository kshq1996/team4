...
<body>
	...
	<div class="nav white">
		...
		<div class="search-bar pr">
			...
			<form action="ProductServlet?method=searchByInputKey" method="post">
				<input id="searchInput" name="inputkey" type="text" placeholder="搜索"> <input id="ai-topsearch" class="submit am-btn" value="搜索" index="1" type="submit">
			</form>
		</div>
	</div>
	...
	<div class="banner">
		...
		<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
			<ul class="am-slides">
				<li class="banner1"><a href="home/introduction.html"><img src="images/ad1.jpg" /></a></li>
		...
		<div class="slideall">
												...
												<div class="menu-srot">
													<div class="sort-side">
														<dl class="dl-sort">
															...
															<dd>
																<a title="蒸蛋糕" href="ProductServlet?method=searchByButton&buttonkey=蒸蛋糕"><span>蒸蛋糕</span></a>
															</dd>
															<dd>
																<a title="脱水蛋糕" href="ProductServlet?method=searchByButton&buttonkey=脱水蛋糕"><span>脱水蛋糕</span></a>
															</dd>
															<dd>
																<a title="瑞士卷" href="ProductServlet?method=searchByButton&buttonkey=瑞士卷"><span>瑞士卷</span></a>
															</dd>
															<dd>
																<a title="软面包" href="ProductServlet?method=searchByButton&buttonkey=软面包"><span>软面包</span></a>
															</dd>
															<dd>
																<a title="马卡龙" href="ProductServlet?method=searchByButton&buttonkey=马卡龙"><span>马卡龙</span></a>
															</dd>
															<dd>
																<a title="千层饼" href="ProductServlet?method=searchByButton&buttonkey=千层饼"><span>千层饼</span></a>
															</dd>
															<dd>
																<a title="甜甜圈" href="ProductServlet?method=searchByButton&buttonkey=甜甜圈"><span>甜甜圈</span></a>
															</dd>
															<dd>
																<a title="蒸三明治" href="ProductServlet?method=searchByButton&buttonkey=蒸三明治"><span>蒸三明治</span></a>
															</dd>
															<dd>
																<a title="铜锣烧" href="ProductServlet?method=searchByButton&buttonkey=铜锣烧"><span>铜锣烧</span></a>
															</dd>
														</dl>
														<dl class="dl-sort">
															<dt>
			...
			<div class="marqueen">
				...
				<div class="demo">
					...
					<ul>
						<li class="title-first"><a target="_blank" href="#"> <img src="images/TJ2.jpg"></img> <span>[特惠]</span>商城爆品1分秒
						</a></li>
						<li class="title-first"><a target="_blank" href="#"> <span>[公告]</span>商城与广州市签署战略合作协议 <img src="images/TJ.jpg"></img>
								<p>XXXXXXXXXXXXXXXXXX</p>
						</a></li>

						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="person/index.html"> <img src="images/getAvatar.do.jpg">
								</a> <em> Hi,<span class="s-name">小叮当</span> <a href="#"><p>点击更多优惠活动</p></a>
								</em>
							</div>
							<div class="member-logout">
								<a class="am-btn-warning btn" href="home/login.jsp">登录</a> <a class="am-btn-warning btn" href="home/register.jsp">注册</a>
							</div>
							<div class="member-login">
								<a href="#"><strong>0</strong>待收货</a> <a href="#"><strong>0</strong>待发货</a> <a href="#"><strong>0</strong>待付款</a> <a href="#"><strong>0</strong>待评价</a>
							</div>
							<div class="clear"></div>
						</div>
			...
			<div class="am-g am-g-fixed recommendation">
				...
				<div class="am-u-sm-4 am-u-lg-3 ">
					...
					<div class="recommendationMain one">
						<a href="home/introduction.html"><img src="images/tj.png "></img></a>
					</div>
				</div>
				<div class="am-u-sm-4 am-u-lg-3 ">
					<div class="info ">
			...
			<div id="f1">
				...
				<div class="am-container ">
					<div class="shopTitle ">
						...
						<div class="today-brands ">
							<a href="# ">桂花糕</a> <a href="# ">奶皮酥</a> <a href="# ">栗子糕 </a> <a href="# ">马卡龙</a> <a href="# ">铜锣烧</a> <a href="# ">豌豆黄</a>
						</div>
				...
				<div class="am-g am-g-fixed floodFour">
					<div class="am-u-sm-5 am-u-md-4 text-one list ">
						<div class="word">
							<a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a> <a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a> <a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a> <a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a> <a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a> <a class="outer" href="#"><span class="inner"><b class="text">核桃</b></span></a>
						</div>
						<a href="# ">
							<div class="outer-con ">
			...
			<div id="f2">
				...
				<div class="am-container ">
					<div class="shopTitle ">
						...
						<h3>酥酥脆脆，回味无穷</h3>
						<div class="today-brands ">
							<a href="# ">腰果</a> <a href="# ">松子</a> <a href="# ">夏威夷果 </a> <a href="# ">碧根果</a> <a href="# ">开心果</a> <a href="# ">核桃仁</a>
						</div>
						<span class="more "> <a href="# ">更多美味<i class="am-icon-angle-right" style="padding-left: 10px;"></i></a>
						</span>
					</div>
	...
	<!--引导 -->
	<div class="navCir">
		<li class="active"><a href="home/home.jsp"><i class="am-icon-home "></i>首页</a></li>
				...
				<div id="prof" class="item ">
					...
					<div class="ibar_login_box status_login ">
						<div class="avatar_box ">
							...
							<ul class="user_info ">
								<li>用户名:<%=((User) session.getAttribute("isLogined")).getUsername()%></li>
								<li>级&nbsp;别:??会员</li>
							</ul>
							...
							<ul class="user_info ">
								<li style="color: orange" onclick="home/login.jsp">还没有登录(⊙o⊙)哦</li>
								<li style="color: orange" onclick="home/login.jsp">赶快从这里登录吧！</li>
							</ul>
							<div class="login_btnbox ">
								<a href="home/login.jsp " class="login_order ">登&nbsp;&nbsp;录</a> <a href="home/register.jsp " class="login_favorite ">注&nbsp;&nbsp;册</a>
							</div>
							<%
								}
							%>
